...
public class MuseumFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        locations.add(new Location(getString(R.string.the_egyptian_museum), R.drawable.egyptianmuseum_museum));
        locations.add(new Location(getString(R.string.the_museum_of_egyptian_antiquities), R.drawable.themuseumofegyptianantiquities_museum));
        locations.add(new Location(getString(R.string.museede_labar_quesolaire), R.drawable.museedelabarquesolaire_museum));
        locations.add(new Location(getString(R.string.grand_egyptian), R.drawable.grandegyptian_museum));
        locations.add(new Location(getString(R.string.the_egyptian_museum), R.drawable.egyptianmuseum_museum));
        locations.add(new Location(getString(R.string.the_museum_of_egyptian_antiquities), R.drawable.themuseumofegyptianantiquities_museum));
        locations.add(new Location(getString(R.string.museede_labar_quesolaire), R.drawable.museedelabarquesolaire_museum));
        locations.add(new Location(getString(R.string.grand_egyptian), R.drawable.grandegyptian_museum));
